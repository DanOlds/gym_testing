...
def choose_action(state, primary_network, eps):
    ...
    if random.random() < eps:
        ...
        #print(f"state.reshape(1, -1): {state.reshape(1, -1)}")
...
def train(primary_network, memory, target_network=None):
    ...
    ##target_q = prim_qt.numpy()  no method .numpy()
    target_q = prim_qt
    updates = rewards
    ...
    if target_network is None:
        ...
        ##prim_action_tp1 = np.argmax(prim_qtp1.numpy(), axis=1) no method .numpy()
